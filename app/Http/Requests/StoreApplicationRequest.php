...
class StoreApplicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'why_applying' => [ 'string'],
            'how_benefit' => [ 'string' ],
            'committee_choices' => ['required', 'array', 'size:1'],
            'committee_choices.*' => [
                'required',
                'string',
                'distinct',
    ...
    public function messages(): array
    {
        return [
            ...
            'committee_choices.required' => 'Please select one committee.',
            'committee_choices.array' => 'Committee selection must be sent as a list.',
            'committee_choices.size' => 'Please select exactly one committee.',
            'committee_choices.*.distinct' => 'Committee selections must be unique.',
            'committee_choices.*.exists' => 'The selected committee is either invalid or currently closed.',
